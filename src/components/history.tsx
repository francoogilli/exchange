            ...
            {historyData.map((item, index) => (
              ...
              >
                ...
                <td className={`px-6 py-5 font-normal`}>
                  <span className={`px-4 py-1 rounded-lg font-normal ${item.action === 'Vender' ? 'bg-emerald-500/20 hover:bg-emerald-500/25 hover:text-emerald-400 text-emerald-500 transition duration-300' : 'bg-red-500/20 hover:bg-red-500/25 hover:text-red-400 text-red-500 transition duration-300'}`}>{item.action}</span>
                </td>
