...
export default function Home() {
  return (
    ...
    <div className="lg:grid text-white grid-cols-2 gap-3 p-2 lg:grid-cols-12 md:grid-cols-3 pb-14">
    ...
    <div className="border-2 col-span-5 p-6 bg-[#151823] border-zinc-800 rounded-2xl ">
      ...
      <div className="flex pb-6 justify-between">
        ...
        <p className="text-2xl font-medium">51,740 <span className="text-teal-400">ARS</span></p>
      </div>

      <div className="pb-2">
        <p className="text-xl text-teal-400 font-medium">Get</p>
        <input type="number" name="" id="" placeholder="0" className="bg-[#151823] border border-zinc-800 rounded-2xl px-4 py-2 w-full" />
      </div>

      <div className="pb-5">
        <p className="text-xl text-teal-400 font-medium">Pay</p>
    ...
    <div className="border col-span-7 border-zinc-800 rounded-2xl ">
      <a href="/history" className="text-3xl text-center p-10">Historial</a>
    </div>
    
    <div className="border col-span-4 border-zinc-800 rounded-2xl ">
      <h2 className="text-3xl text-center p-10">Composicion</h2>
    </div>
    <div className="border col-span-4 border-zinc-800 rounded-2xl ">
